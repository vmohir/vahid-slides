...
import { ArrayElement } from '@app/Interfaces';
  ...
  export class FormBuilder {
    ...
    group<T>(
      controlsConfig: {
        [P in keyof T]:
          | FormGroup<T[P]>
          | FormArray<T[P] extends any[] ? T[P] : any[]>
          | FormControl<T[P]>
          | [(T[P] | undefined)?, (ValidatorFn | ValidatorFn[] | AbstractControlOptions)?]
          | [{ value: T[P] | undefined; disabled: boolean }, (ValidatorFn | ValidatorFn[] | AbstractControlOptions)?]
      },
      options?:
